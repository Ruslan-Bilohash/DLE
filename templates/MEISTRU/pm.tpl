<article class="box story style="border: 1px solid black;"">
	<div class="box_in">
		...
		<div class="addform addpm">
			...
			<div class="form_submit">
				...
				[/sec_code]
				<button style="background-color: black; color: white;" class="btn btn-big" type="submit" name="add"><b>Отправить</b></button>
				<button style="border: 1px solid black;" class="btn-border btn-big" type="button" onclick="dlePMPreview()">Предпросмотр</button>
			</div>
		</div>
		[/newpm]
	</div>
