		...
		<div class="tab-content">
			<div class="tab-pane active" id="user1"><h1>Расценки в Литве актуально на: {date}</h1> 
				<ul class="usinf">	цена в євро за метр	квадратный или погоный.	
					...
					<li><div class="ui-c1 grey">Поклейка бумажных обоев на стены</div> <div class="ui-c2">[xfvalue_price_oboi_steny]</div></li>					
					<li><div class="ui-c1 grey">Поклейка бумажных обоев на потолок</div> <div class="ui-c2">[xfvalue_price_oboi_potolok]</div></li>
					<li><div class="ui-c1 grey">Поклейка фото обоев на стены</div> <div class="ui-c2">[xfvalue_price_oboi_fotosteny]</div></li>
					<li><div class="ui-c1 grey">Поклейка фото обоев на потолок</div> <div class="ui-c2">[xfvalue_price_oboi_fotopotolok]</div></li>
					<li><div class="ui-c1 grey">Поклейка флизелиновых обоев на стены</div> <div class="ui-c2">[xfvalue_price_oboi_flizelin_steny]</div></li>
					<li><div class="ui-c1 grey">Поклейка флизелиновых обоев на потолок</div> <div class="ui-c2">[xfvalue_price_oboi_flizelin_potolok]</div></li>
					<li><div class="ui-c1 grey">Поклейка виниловых обоев на стены</div> <div class="ui-c2">[xfvalue_price_oboi_vinil_steny]</div></li>
					<li><div class="ui-c1 grey">Поклейка виниловых обоев на потолок</div> <div class="ui-c2">[xfvalue_price_oboi_vinil_potolok]</div></li>
					<li><div class="ui-c1 grey">Поклейка стеклохолста (стекловолокна)</div> <div class="ui-c2">[xfvalue_price_oboi_steklovolokno]</div></li>
					<li><div class="ui-c1 grey">Пробковые обои</div> <div class="ui-c2">[xfvalue_price_oboi_probkovie]</div></li>
					<li><div class="ui-c1 grey">Обои жидкого нанесения</div> <div class="ui-c2">[xfvalue_price_oboi_jidkie]</div></li>
					<li><div class="ui-c1 grey">Грунтование</div> <div class="ui-c2">[xfvalue_price_oboi_gruntovanie]</div></li>					
