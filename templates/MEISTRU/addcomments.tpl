<div class="box">
	<div id="addcomment" class="addcomment">
		<div class="plus_icon"><span>Добавить комментарий (отзыв)</span></div>
		<div class="box_in">
			...
			[/sec_code]
				<center><button class="button-orange" type="submit" name="submit" title="Отправить отзыв"><b>Отправить отзыв</b></button><center>
			</div>
		</div>
	</div>
</div>