	...
	<li class="dropdown">
		...
		<div class="dropdown-form dot logged">
			<div class="login_pane__info">
				...
				[admin-link]<div class="login_pane__admin"><a href="{admin-link}" target="_blank">Админпанель</a></br><a href="/odifarka.php?mod=static&action=addnew" target="_blank">Создание новой страницы</a></div>[/admin-link]
			</div>
			<ul class="login_pane__menu">
                <center><a class="btn-pulse" href="/addnews.html" title="ДОБАВИТЬ ВАКАНСИЮ, объявления, резюме, услугу">Добавить заказ</a></center></br>
				...
				<li><a href="/index.php?do=newpost">Непросмотреные</a></li>
			</ul>
			<div class="login_pane__foot">				
               <center><a class="button-green" href="{logout-link}"> Выход</a></center>
...
<ul id="login_pane">
	<li class="dropdown">                      
		<a data-toggle="dropdown" class="btn-border" href="#"><b>Войти</b></a>
                       <!-- [facebook]<a class="btn" style="background-color: white; color: black;" href="{facebook_url}">F</a><i></i></h2>[/facebook]-->
		<form class="dropdown-form dot" method="post">
			<div class="soc_links">
				...
				[google]
				Войдите через GOOGLE: <a href="{google_url}" target="_blank" class="soc_gp">
