...
Если не получилось созвонится с автором напишите нам: <a href="https://t.me/meistru_lt" title="telegram" alt="Телеграм"/>Открыть в Telegram</a> (Строительвство и ремонт!)<br>
		...
		<div class="tab-content">
			<div class="tab-pane active" id="user1">Расценки в Литве актуально на: {date}</br>
				<ul class="usinf">	цена в євро за метр	квадратный или погоный.	
					...
					<li><div class="ui-c1 grey">Гипсовая штукатурка по маякам:</div> <div class="ui-c2">[xfvalue_price_shtukaturka_gipsovaya] EUR.</div></li>
					<li><div class="ui-c1 grey">Простая штукатурка без маяков:</div> <div class="ui-c2">[xfvalue_price_shtukaturka_bezmayakov] EUR.</div></li>					
					<li><div class="ui-c1 grey">Штукатурка откосов до 40 см.:</div> <div class="ui-c2">[xfvalue_price_shtukaturka_otkosov] EUR.</div></li>
					<li><div class="ui-c1 grey">Штукатурка ниш и радиаторов:</div> <div class="ui-c2">[xfvalue_price_shtukaturka_nish] EUR.</div></li>
					<li><div class="ui-c1 grey">Машиная штукатурка:</div> <div class="ui-c2">[xfvalue_price_shtukaturka_mashinaya] EUR.</div></li>
					<li><div class="ui-c1 grey">Штукатурка потолков:</div> <div class="ui-c2">[xfvalue_price_shtukaturka_potolkov] EUR.</div></li>
					<li><div class="ui-c1 grey">Набивка сетки:</div> <div class="ui-c2">[xfvalue_price_shtukaturka_setka] EUR.</div></li>
					<li><div class="ui-c1 grey">Грунтование под штукатурку:</div> <div class="ui-c2">[xfvalue_price_shtukaturka_gruntovanie] EUR.</div></li>
					<li><div class="ui-c1 grey">Грунтование бетон контактом:</div> <div class="ui-c2">[xfvalue_price_shtukaturka_kontakt] EUR.</div></li>
					<li><div class="ui-c1 grey">Установка уголков:</div> <div class="ui-c2">[xfvalue_shtukaturka_ugolki] EUR.</div></li>
					<li><div class="ui-c1 grey">Установка маяков:</div> <div class="ui-c2">[xfvalue_shtukaturka_ugolki] EUR.</div></li>
