		...
		<div class="tab-content">
			<div class="tab-pane active" id="user1"><h1>Расценки в Литве актуально на: {date}</h1> 
				<ul class="usinf">цена в євро за метр	квадратный или погоный.	
					...
					<li><div class="ui-c1 grey">Установка, монтаж деревяной вагонки: </div> <div class="ui-c2">[xfvalue_price_vagonka] EUR.</div></li>
					<li><div class="ui-c1 grey">Установка, монтаж ПВХ вагонки: </div> <div class="ui-c2">[xfvalue_price_pvx_vagonka] EUR.</div></li>
					<li><div class="ui-c1 grey">Установка, монтаж вагонки на потолок: </div> <div class="ui-c2">[xfvalue_price_vagonka_potolok] EUR.</div></li>
					<li><div class="ui-c1 grey">Установка, монтаж бруса: </div> <div class="ui-c2">[xfvalue_price_vagonka_brus] EUR.</div></li>
					<li><div class="ui-c1 grey">Установка, монтаж терасной доски: </div> <div class="ui-c2">[xfvalue_price_vagonka_terasa] EUR.</div></li>
					<li><div class="ui-c1 grey">Установка деревяных уголков: </div> <div class="ui-c2">[xfvalue_price_vagonka_ugolki] EUR.</div></li>
					<li><div class="ui-c1 grey">Установка деревяных плинтусов: </div> <div class="ui-c2">[xfvalue_price_vagonka_plintus] EUR.</div></li>
