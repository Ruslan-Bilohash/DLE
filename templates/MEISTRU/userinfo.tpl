...
.btn-pulse {
    background-color: orange; /* Пример фона */
    border: none;
    padding: 20px 16px;
    border-radius: 5px;
    cursor: pointer;
...
.btn-pulse a {
    color: #ffffff !important; /* Белый цвет для ссылки внутри кнопки */
    text-decoration: none; /* Убирает подчеркивание */
}

.btn-pulse a:hover {
    color: #ffffff; /* Сохраняет белый цвет при наведении */
}</style>
<article class="box story" style="border: 3px solid black;">
	...
	<div class="box_in"> 
		<div class="tab-content">
			<div class="tab-pane active" id="user1">
                <center><img src="{foto}" alt="{login}" class="user-avatar"></center>
                [group=5]   <center><a class="btn-pulse" href="/index.php?do=register" title="Кнопка регистрации чтобы отправить сообщения">Отправить личное сообщения</a>
         </center>     
       [/group]
               
                   [not-group=5]<center><button class="btn-pulse">{pm}</button></center>[/not-group]</br>
                           [not-logged]        
            <center><a class="button-green" href="#user2"  data-toggle="tab"> Редактировать профиль</a></center>
                   [/not-logged] 
				<ul class="usinf">				
					<li><div class="ui-c1 grey">Рейтинг</div> <div class="ui-c2">{rate}</div></li>
					<li><div class="ui-c1 grey">Форма собствености:</div> <div class="ui-c2">[xfvalue_about]</div></li>
					<li><div class="ui-c1 grey">Имя и Фамилия</div> <div class="ui-c2">{fullname}[not-fullname]Неизвестно[/not-fullname]</div></li>					
					<li><div class="ui-c1 grey">Номер телефона:</div> <div style="color: red;" class="ui-c2">[xfvalue_phone] (видно только зарегистрированым пользователям.)</div> </li>
					<li><div class="ui-c1 grey">Выполняет вид работ:</div> <div class="ui-c2">[xfvalue_specialnost]</div></li>
					<li><div class="ui-c1 grey">Стаж работы:</div> <div class="ui-c2">[xfvalue_staj]</div></li>
			...
			<div class="tab-pane" id="user2">
				...
				<div id="options">
					<div class="addform">
						<ul class="ui-form">
<li class="form-group">
								<label for="image">Загрузить новую фотографию профиля</label>
...
<li class="form-group form-sep"></li>							
						<!--	<li class="form-group">
							...
							<li class="form-group">
								<label for="signature">Ваша реклама в комментах.</label>
						...
						<div class="form_submit">
							<center><button class="btn-pulse" name="submit" type="submit"><b>Сохранить</b></button></center>
